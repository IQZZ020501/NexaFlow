...
export const AUDIT_ACTION_LABEL_KEYS: Record<string, TranslationKey> = {
  ...
  "knowledge_graph.settings.update": "更新图谱设置",
  "knowledge_graph.schema.create": "创建图谱 Schema",
  "knowledge_graph.rebuild.enqueue": "排队重建图谱",
  "knowledge_graph.records.import": "导入图谱记录",
  "knowledge_graph.review.resolve": "处理图谱评审",
  "knowledge_graph.revision.publish": "发布图谱修订",
