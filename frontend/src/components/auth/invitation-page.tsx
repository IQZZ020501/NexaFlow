...
export function InvitationPage({ token, generic = false }: { token: string; generic?: boolean }) {
  ...
  return (
    <main className="flex min-h-dvh items-start justify-center bg-muted/20 p-4 py-8 pt-[max(2rem,env(safe-area-inset-top))] pb-[max(2rem,env(safe-area-inset-bottom))] sm:items-center sm:py-4">
