...
from app.domain.knowledge.graph.extraction import (  # noqa: F401
    ExtractionChunk,
...
from app.domain.knowledge.graph.resolution import (  # noqa: F401
    choose_automatic_entity_match,
    claim_fingerprint,
    initial_claim_status,
)
from app.domain.knowledge.graph.revisions import (  # noqa: F401
