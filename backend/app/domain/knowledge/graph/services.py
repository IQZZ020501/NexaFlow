...
from app.domain.knowledge.graph.revisions import (  # noqa: E402,F401
    GraphRevisionConflict,
    create_revision,
    publish_revision,
    stage_revision_change,
)
from app.domain.knowledge.graph.extraction import (  # noqa: E402,F401
    ExtractionChunk,
...
from app.domain.knowledge.graph.resolution import (  # noqa: E402,F401
    claim_fingerprint,
