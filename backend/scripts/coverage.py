...
SUITES = (
    ...
    "platform.system_governance",
    "platform.workspaces",
    "platform.teams",
    "platform.resource_folders",
    "platform.workspace_admin_coverage",
    "knowledge.knowledge",
    "knowledge.knowledge_graph",
    "knowledge.knowledge_graph_edge_coverage",
    "knowledge.knowledge_domain_coverage",
    "knowledge.knowledge_api_coverage",
    "models.llm",
    "agents.agents",
    "agents.agent_access",
    "agents.agent_services_coverage",
    "agents.agent_runtime_coverage",
    "workflows.workflows",
    "workflows.workflow_run_coverage",
    "workflows.workflow_node_coverage",
    "tools.tools",
    "smoke.test_main",
)
